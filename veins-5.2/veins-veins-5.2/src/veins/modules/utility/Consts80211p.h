 ...
 */
const uint64_t NUM_BITRATES_80211P = 10;
const uint64_t BITRATES_80211P[] = {6800000, 13500000, 20300000, 27000000, 40500000, 54000000, 60800000, 67500000, 81000000, 90000000 };
 ...
 */
const uint32_t N_DBPS_80211P[] = {54, 108, 162, 216, 324, 432, 486, 540, 648, 730 };
 ...
 */
const uint64_t PHY_HDR_BITRATE = 6800000;
...
const Bandwidth BANDWIDTH_11P = Bandwidth::ofdm_20_mhz;
