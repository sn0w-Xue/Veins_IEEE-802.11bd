...
//        break;
    ...
    case MCS::ofdm_qam16_r_3_4:
        ...
        return getFec16QamBer(snr_mW + 4, nbits, 3);
        break;
    case MCS::ofdm_qam64_r_2_3:
        return getFec64QamBer(snr_mW + 4, nbits, 2);
        break;
    case MCS::ofdm_qam64_r_3_4:
        return getFec64QamBer(snr_mW + 4, nbits, 3);
        break;
    case MCS::ofdm_qam64_r_5_6:
        return getFec64QamBer(snr_mW + 4, nbits, 5);
        break;
    case MCS::ofdm_qam256_r_3_4:
        return getFec256QamBer(snr_mW + 4, nbits, 3);
        break;
    case MCS::ofdm_qam256_r_5_6:
        return getFec256QamBer(snr_mW + 4, nbits, 5);
        break;
    default:
